...
<div class="about">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-img">
                    <img src="https://previews.123rf.com/images/nejron/nejron1507/nejron150700101/42094247-man-worker-washing-luxury-car-on-a-car-wash.jpg" alt="Image">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://autoimage.capitalone.com/cms/Auto/assets/images/1616-hero-pressure-wash-a-car.jpg" width="100px" height="100px" alt="">
                    <h3>Exterior Washing</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://media.istockphoto.com/id/1288964234/photo/car-detailing-service-deep-interior-cleaning.jpg?s=612x612&w=0&k=20&c=O1jFEKtCipreEAIOhEkIwYxkq0OBd8rMYe8bOFPngtc=" width="100px" height="100px" alt="">
                    <h3>Interior Washing</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://m.media-amazon.com/images/I/61w5rRSbt2S._UF1000,1000_QL80_.jpg" width="100px" height="100px" alt="">
                    <h3>Vacuum Cleaning</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://motorgy.b-cdn.net/live/CarImages/cbaee914-c0b4-4be6-bfaf-98401be09249.webp" width="100px" height="100px" alt="">
                    <h3>Seats Washing</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://metroautoglass.com.au/wp-content/uploads/car-window-cleaning.jpg" width="100px" height="100px" alt="">
                    <h3>Window Wiping</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://media.istockphoto.com/id/1287044692/photo/worker-washing-red-car-with-sponge-on-a-car-wash.jpg?s=612x612&w=0&k=20&c=_6WO9k1qkDub5CAEQgnORMduUoQJkU6w3jjVQTdTdwQ=" width="100px" height="100px" alt="">
                    <h3>Wet Cleaning</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://www.communityautoinc.com/Files/EmailCampaigns/AdobeStock_251971442.jpeg" width="100px" height="100px" alt="">
                    <h3>Oil Changing</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="service-item">
                    <img id="service" src="https://www.boschcarservice.com/xrm/media/services/brake_service_image_640w_360h.jpg" width="100px" height="100px" alt="">
