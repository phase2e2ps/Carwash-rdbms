...
<div class="left-content">
    ...
    <!--heder end here-->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./admin-dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Car Washing Points</li>
    </ol>
            ...
            <div class="w3l-table-info">
                ...
                <table id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-th="#"><span class="bt-content">1</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content">Cielo Car Washing Point</span></td>
                            <td data-th="Address"><span class="bt-content">ABC Street New Delhi 1110001</span></td>
                            <td data-th="Contact Number"><span class="bt-content">1236547890</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2021-12-14 00:21:20</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=1">Edit</a> | <a href="managecar-washingpoints.php?rid=1" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>

                        <tr>
                            <td data-th="#"><span class="bt-content">2</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content">ABC Car Washing Point</span></td>
                            <td data-th="Address"><span class="bt-content">A3263 Sector 1- Noida 201301</span></td>
                            <td data-th="Contact Number"><span class="bt-content">98745463210</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2021-12-14 00:22:38</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=2">Edit</a> | <a href="managecar-washingpoints.php?rid=2" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>

                        <tr>
                            <td data-th="#"><span class="bt-content">3</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content"> Matrix Car washing Point </span></td>
                            <td data-th="Address"><span class="bt-content">H911 Indira Puram Ghaziabad 201017 UP</span></td>
                            <td data-th="Contact Number"><span class="bt-content">4582365419</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2021-12-14 00:24:28</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=3">Edit</a> | <a href="managecar-washingpoints.php?rid=3" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>

                        <tr>
                            <td data-th="#"><span class="bt-content">4</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content">Pawing Car Wash Center</span></td>
                            <td data-th="Address"><span class="bt-content">Pawing, Palo, Leyte</span></td>
                            <td data-th="Contact Number"><span class="bt-content">9123456789</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2024-11-20 14:27:56</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=6">Edit</a> | <a href="managecar-washingpoints.php?rid=6" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>

                        <tr>
                            <td data-th="#"><span class="bt-content">5</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content">Poto's War Wash</span></td>
                            <td data-th="Address"><span class="bt-content">Pater St. Tacloban CIty</span></td>
                            <td data-th="Contact Number"><span class="bt-content">9123456789</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2024-11-26 11:01:55</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=7">Edit</a> | <a href="managecar-washingpoints.php?rid=7" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>

                        <tr>
                            <td data-th="#"><span class="bt-content">6</span></td>
                            <td data-th="Washing Point Name"><span class="bt-content">Jake Car Wash0</span></td>
                            <td data-th="Address"><span class="bt-content">Government Center, Palo Leyte, Sample</span></td>
                            <td data-th="Contact Number"><span class="bt-content">912345679890</span></td>
                            <td data-th="Creation Date"><span class="bt-content">2025-08-27 10:31:32</span></td>
                            <td data-th="Action"><span class="bt-content">
                                    <a href="editcar-washpoint.php?wpid=9">Edit</a> | <a href="managecar-washingpoints.php?rid=9" style="color:red;" onclick="return confirm('Do you really want to delete');">Delete</a></span></td>
                        </tr>
                    </tbody>
                </table>
            </div>
