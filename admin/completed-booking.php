    ...
    <div class="left-content">
        ...
        <!--heder end here-->
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="../admin/admin-dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Completed Bookings </li>
        </ol>
        <!--grid-->
        <div class="grid-form">

            <!---->
        <h1>This page is under constractions...</h1>